...
#define HAVE_divmoddi4_hilo_di ((!TARGET_64BIT) && (TARGET_64BIT))
#define HAVE_udivmoddi4_hilo_di ((!TARGET_64BIT) && (TARGET_64BIT))
...
#define HAVE_mthidi_di ((!TARGET_64BIT) && (TARGET_64BIT))
