...
ifeq ($(DUMP),)
  define BuildTarget/ipkg
	...
	#XXX:Making debug package. AKA NO strip.
	$(IPKG_BUILD) $$(IDIR_$(1)) $(DEBUG_PACKAGE_DIR)
	mv $(DEBUG_PACKAGE_DIR)/$(1)_$(VERSION)_$(PKGARCH).ipk $(DEBUG_PACKAGE_DIR)/$(1)_$(VERSION)_$(PKGARCH)_debug.ipk 

	$(RSTRIP) $$(IDIR_$(1))
	#XXX: change lua script to bytecode
	/usr/bin/env python $(SCRIPT_DIR)/rluac.py $(STAGING_DIR_HOST) $$(IDIR_$(1))

	#XXX:Striped-packages used in rom	
