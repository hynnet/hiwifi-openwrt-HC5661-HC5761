...
typedef enum { BOOTP, RARP, ARP, TFTP, DHCP, PING, DNS, NFS, CDP, NETCONS, PROG } proto_t;
...
#define PROG_MAXLINE   1024
#define PROG_DEF_PORT  6667

typedef enum { S_LISTEN, S_REQUEST, S_REPLY, S_SETENV, S_QUIT } prog_cmd_t;
