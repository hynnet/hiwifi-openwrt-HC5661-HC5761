...
int do_prog (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	if (NetLoop(PROG) < 0) {
		printf("prog finished abnormally\n");
		return 1;
	}

	printf("prog finished normally\n");
...
U_BOOT_CMD(
	prog,   1,      1,      do_prog,
	"prog\t- Entering PROG mode to be programmed by remote hosts\n",
	"\n"
);
#endif /* CFG_CMD_PROG */
