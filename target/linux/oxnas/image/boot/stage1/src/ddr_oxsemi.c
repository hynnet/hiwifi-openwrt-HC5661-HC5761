...
//static const T_DDR_TIMING_PARAMETERS C_TP_DDR2_25_CL6_1GB  = { 5, 6, 0, 2, 5, 4, 6,45,22,27,10,12,16, 6, 5, 6,      9,      1,  1,  1,       2, 75, 56, 56}; // 400MHz, Speedgrade 25 timings (4Gb parts)
//static const T_DDR_TIMING_PARAMETERS C_TP_DDR2_25_CL6_1GB  = { 4, 5, 0, 2, 4, 4, 4,51,22,26,10,12,18, 6, 5, 6,      3,      1,  0,  1,       2, 75, 56, 56}; // 400MHz, Speedgrade 25 timings (1Gb parts)
...
//static const T_DDR_CONFIG_PARAMETERS C_CP_DDR2_25_CL6   = { 2,8, 2, 1, 2, 128,25,0x80200A63}; // 512 MByte
...
static void ddr_normal_initialisation(const T_DDR_CONFIG_PARAMETERS *ddr_config_parameters, int mhz)
{
    ...
    //Michael add setting ddramio_ds_other reg.
    * (volatile UINT *) SYS_CTRL_DDRAMIO_CTRL_ADDR  = 0x22;
...
void ddr_oxsemi_setup(int mhz)
{
    ...
    * (volatile UINT *) C_DDR_TRANSACTION_ROUTING = 
	(0 << DDR_ROUTE_CPU0_INSTR_SHIFT) 	|
